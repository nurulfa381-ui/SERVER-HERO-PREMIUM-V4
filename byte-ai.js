...
kp02Tip:"Distinguish preventive, corrective and predictive maintenance. Remember backups and records.",kp03Tip:"Focus on access control, temperature, humidity, fire safety, UPS and emergency procedures.",kp04Tip:"Select tools according to the task. Prioritise ESD protection, safe shutdown and never force components.",kp05Tip:"Follow the installation order: boot media, language, edition, Custom Installation, partition and Administrator password.",kp06Tip:"AD DS Virtual Lab: install the role, choose Add a new forest, use serverhero.local and set a DSRM password.",kp07Tip:"DNS Virtual Lab: create the Primary Forward Lookup Zone serverhero.local, add the dc01 A record and test with nslookup.",kp08Tip:"DHCP Virtual Lab: install the role, authorise the server, create a scope, set the range, gateway, DNS and activate the scope.",kp09Tip:"Use Active Directory Users and Computers to create the STAFF OU, the ali user and the IT-STAFF security group.",kp10Tip:"Backup Virtual Lab: install Windows Server Backup, choose Backup Once, Full Server, save to drive E:, then test file recovery.",kp11Tip:"File Server Lab: create D:\\SHARE\\HR, configure Share and NTFS permissions for HR-GROUP, then map it as drive Z:.",kp13Tip:"Cabaran akhir: lengkapkan semua tugas enterprise, semak konfigurasi dan selesaikan ujian akhir.",kp12Tip:"GPO Lab: create STAFF-POLICY, link it to the STAFF OU, disable Control Panel, set a wallpaper and test with gpupdate /force.",
...
function tip(){
const key=context==="kp01"?"kp01Tip":context==="kp02"?"kp02Tip":context==="kp03"?"kp03Tip":context==="kp04"?"kp04Tip":context==="kp05"?"kp05Tip":context==="kp06"?"kp06Tip":context==="kp07"?"kp07Tip":context==="kp08"?"kp08Tip":context==="kp09"?"kp09Tip":context==="kp10"?"kp10Tip":context==="kp11"?"kp11Tip":context==="kp12"?"kp12Tip":context==="kp13"?"kp13Tip":"dashboardTip";
addMessage(t(key));
}
function readPage(){
const txt=pageText();
