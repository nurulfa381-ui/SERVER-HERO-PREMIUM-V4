...
kp02Tip:"Distinguish preventive, corrective and predictive maintenance. Remember backups and records.",kp03Tip:"Focus on access control, temperature, humidity, fire safety, UPS and emergency procedures.",kp04Tip:"Select tools according to the task. Prioritise ESD protection, safe shutdown and never force components.",kp05Tip:"Follow the installation order: boot media, language, edition, Custom Installation, partition and Administrator password.",kp06Tip:"AD DS Virtual Lab: install the role, choose Add a new forest, use serverhero.local and set a DSRM password.",
...
function tip(){
const key=context==="kp01"?"kp01Tip":context==="kp02"?"kp02Tip":context==="kp03"?"kp03Tip":context==="kp04"?"kp04Tip":context==="kp05"?"kp05Tip":context==="kp06"?"kp06Tip":"dashboardTip";
addMessage(t(key));
}
function readPage(){
const txt=pageText();
